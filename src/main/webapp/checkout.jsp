                ...
                <div class="space-y-4">
                    ...
                    <div class="border border-dashed border-amber-200 rounded-2xl p-4 space-y-3">
                        ...
                        <div class="flex gap-3">
                            <select id="checkoutCouponSelect" class="flex-1 border rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
