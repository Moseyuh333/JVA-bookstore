        ...
        <div id="content">
            <div class="container-fluid">
                <div class="page-title">
                    <h1>Quản lý nhà vận chuyển</h1>
                    <p>CRUD nhà vận chuyển, phí, khu vực, trạng thái hoạt động</p>
                </div>
                ...
                <div class="stats-grid">
                    <div class="stat-box total">
                        ...
                        <div class="stat-content">
                            <h3>Tổng nhà vận chuyển</h3>
                            <div class="number" id="totalShippers">0</div>
                        </div>
                    </div>
                    <div class="stat-box active">
                        ...
                        <div class="stat-content">
                            ...
                            <div class="number" id="activeShippers">0</div>
                        </div>
                    </div>
                </div>
