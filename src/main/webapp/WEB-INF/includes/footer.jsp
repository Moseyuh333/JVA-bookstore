...
<%
    ...
    String catNovel = URLEncoder.encode("Tiểu thuyết", "UTF-8");
    String catNonFiction = URLEncoder.encode("Phi tiểu thuyết", "UTF-8");
    String catGifts = URLEncoder.encode("Quà tặng", "UTF-8");
%>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="<%=ctx%>/catalog.jsp?category=<%=catNovel%>" class="hover:text-white">Tiểu thuyết</a></li>
                    <li><a href="<%=ctx%>/catalog.jsp?category=<%=catNonFiction%>" class="hover:text-white">Phi tiểu thuyết</a></li>
                    <li><a href="<%=ctx%>/catalog.jsp?category=<%=catGifts%>" class="hover:text-white">Thẻ quà tặng</a></li>
                </ul>
            </div>
            <div>
