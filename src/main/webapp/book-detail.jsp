      ...
      <div class="overflow-x-auto">
        <table class="min-w-full border-collapse">
          <tbody class="divide-y divide-[#333] text-gray-300">
            <tr><td class="py-3 font-semibold w-1/3 text-gray-400">UPC</td><td>${bookUpc}</td></tr>
            <tr><td class="py-3 font-semibold text-gray-400">Product Type</td><td>Books</td></tr>
            <tr><td class="py-3 font-semibold text-gray-400">Price (excl. tax)</td><td>$${bookPrice}</td></tr>
            <tr><td class="py-3 font-semibold text-gray-400">Price (incl. tax)</td><td>$${bookPrice}</td></tr>
            <tr><td class="py-3 font-semibold text-gray-400">Tax</td><td>$0.00</td></tr>
            <tr><td class="py-3 font-semibold text-gray-400">Availability</td>
              <td>
                <c:choose>
                  <c:when test="${bookInStock}">
            ...
            <tr><td class="py-3 font-semibold text-gray-400">Number of reviews</td><td>${reviewCount}</td></tr>
          </tbody>
        </table>
      </div>
    </div>
